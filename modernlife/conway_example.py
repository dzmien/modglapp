...
class Conway(BaseApp):
    title = "(floatwong) Conway's Game of Life"
    ...
    def __init__(self, **kwargs):
        ...
        self.click_buffer = np.zeros((self.width, self.height), dtype='f4')
...
#        self.vao.render(moderngl.TRIANGLE_STRIP)
    ...
    def mouse_press_event(self, x, y, button):
        print("@{}:\" {} \" on ({}, {})".format(self.last_updated, button, x, y))
